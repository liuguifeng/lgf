...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="/Public/Admin/Images/ecshop_logo.gif" alt="YANBEI - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
            <li></a></li>
            <li></a></li>
            <li style="border-right:none"></a></li>
        </ul>
        <div id="send_info">
            <a href="<?php echo U('Admin/Index/rmcache');?>" target="main-frame" class="fix-submenu">清除缓存</a>
            <a href="<?php echo U('Admin/Login/logout');?>" target="_top" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
